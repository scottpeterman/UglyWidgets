...
class Ui_NESTMainWindow(object):
    def setupUi(self, NESTMainWindow):
        ...
        ssh_data = self.get_ssh_credentials()  # Prompt user for SSH credentials

        if ssh_data is not None:
            self.SSH = SSH(ssh_data, self.widget_5)
    ...
    def get_ssh_credentials(self):
        ...
        username_line_edit = QtWidgets.QLineEdit()
        password_line_edit = QtWidgets.QLineEdit()
        password_line_edit.setEchoMode(QtWidgets.QLineEdit.EchoMode.Password)

        layout.addRow(ip_label, ip_line_edit)
        layout.addRow(username_label, username_line_edit)
        layout.addRow(password_label, password_line_edit)
        ...
        if dialog.exec() == QtWidgets.QDialog.DialogCode.Accepted:
            ...
            return {"host": ip, "username": username, "password": password}
